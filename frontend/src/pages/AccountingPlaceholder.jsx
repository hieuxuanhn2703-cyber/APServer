  ...
  return (
    <div className="card" style={{ maxWidth: '900px', margin: '20px auto' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
        ...
        <div>
          <h2 style={{ fontSize: '1.25rem', fontWeight: 700 }}>Kế Toán & Tài Chính (Khung Nền Tảng)</h2>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>
            Phân hệ theo dõi đơn giá, doanh thu tổ may, và thanh toán tiền công.
          </p>
        </div>
      </div>
      ...
      <div className="alert alert-info" style={{ marginTop: '16px' }}>
        ...
        <p style={{ marginTop: '4px', fontSize: '0.85rem' }}>
          REST API đã sẵn sàng: <code>/api/v1/accounting/prices/</code>, <code>/api/v1/accounting/payments/</code>
        </p>
      </div>
    </div>
  );
